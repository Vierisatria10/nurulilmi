    ...
    <div class="page-title-area py-lg-6 py-5 bg-image-pattern">
        <div class="container">
            <div class="page-title-wrapper text-center">
                <h1 class="text-white mb-2">Ibadah dan Dakwah</h1>
                <nav class="page-breadcrumb">
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item"><a href='<?= base_url('home') ?>'>Home</a></li>
                        <li class="breadcrumb-item active">Ibadah Dan Dakwah</li>
                    </ol>
                </nav>
            </div>
        </div>
    ...
    <div class="team-area py-lg-10 py-8">
        <div class="container">
            <div class="section-title text-center mb-4">
                ...
                <h2 class="h1">Ibadah Dan Dakwah</h2>
            </div>
            <?php if(!empty($data_dakwah)) : ?>
            <div class="row">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="team-item mt-4">
                        <div class="team-image">
                            ...
                            <img src="<?= base_url('upload/bidang/'.$dakwah->foto) ?>" alt="title">
                            <?php else: ?>
                            <img src="<?= base_url('upload/default.png') ?>" alt="">
                            <?php endif; ?>
                        </div>
                        <div class="team-content">
                            <h5>Nama &nbsp;: <?= $dakwah->nama ?></h5>
                            <span class="text-primary">Jabatan : <?= $dakwah->jabatan ?></span>
                            <br>
                            <span>Alamat &nbsp;: <?= $dakwah->alamat ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <?php else: ?>
            <h3 class="text-center text-danger">"Data Ibadah Dan Dakwah Belum Ada"</h3>
            <?php endif; ?>
        </div>
    </div>
    <!--  ====================== Footer Area =============================  -->
