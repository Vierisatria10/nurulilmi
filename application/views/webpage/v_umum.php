...
<body>
    ...
    <div class="team-area py-lg-10 py-8">
        <div class="container">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="team-item mt-4">
                        <div class="team-image">
                            ...
                            <img src="<?= base_url('upload/bidang/'.$umum->foto) ?>" alt="title">
                            <?php else: ?>
                            <img src="<?= base_url('upload/default.png') ?>" alt="">
                            <?php endif; ?>
                        </div>
                        <div class="team-content">
                            <h5>Nama &nbsp;: <?= $umum->nama ?></h5>
                            <span class="text-primary">Jabatan : <?= $umum->jabatan ?></span>
                            <br>
                            <span>Alamat &nbsp;: <?= $umum->alamat ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <?php else: ?>
            <h3 class="text-center">"Data Umum dan Kerumahtanggaan Belum Ada"</h3>
            <?php endif; ?>
        </div>
    </div>
    <!--  ====================== Footer Area =============================  -->
