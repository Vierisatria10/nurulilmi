...
<body>
    ...
    <div class="team-area py-lg-10 py-8">
        <div class="container">
            ...
            <?php if(!empty($data_kartib)) : ?>
            <div class="row">
                <?php foreach($data_kartib as $kartib) : ?>
                <div class="col-sm-6 col-lg-3">
                    <div class="team-item mt-4">
                        <div class="team-image">
                            ...
                            <?php if(!empty($kartib->foto)) : ?>
                            <img src="<?= base_url('upload/bidang/'.$kartib->foto) ?>" alt="title">
                            <?php else: ?>
                            <img src="<?= base_url('upload/default.png') ?>" alt="">
                            <?php endif; ?>
                        </div>
                        <div class="team-content">
                            <h5>Nama &nbsp;: <?= $kartib->nama ?></h5>
                            <span class="text-primary">Jabatan : <?= $kartib->jabatan ?></span>
                            <br>
                            <span>Alamat &nbsp;: <?= $kartib->alamat ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <?php else: ?>
            <h3 class="text-center">"Data Keamanan & Ketertiban Belum Ada"</h3>
            <?php endif; ?>
        </div>
    </div>
    <!--  ====================== Footer Area =============================  -->
