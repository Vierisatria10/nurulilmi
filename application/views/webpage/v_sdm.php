...
<body>
    ...
    <div class="team-area py-lg-10 py-8">
        <div class="container">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="team-item mt-4">
                        <div class="team-image">
                            ...
                            <img src="<?= base_url('upload/bidang/'.$sdm->foto) ?>" alt="title">
                            <?php else: ?>
                        ...
                        <div class="team-content">
                            <h5>Nama &nbsp;: <?= $sdm->nama ?></h5>
                            <span class="text-primary">Jabatan : <?= $sdm->jabatan ?></span>
                            <br>
                            <span>Alamat &nbsp;: <?= $sdm->alamat ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <?php else: ?>
            <h3 class="text-center">"Data SDM & Pendidikan Belum Ada"</h3>
            <?php endif; ?>
        </div>
    </div>
    <!--  ====================== Footer Area =============================  -->
