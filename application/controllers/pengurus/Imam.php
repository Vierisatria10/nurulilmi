...
class Imam extends CI_Controller {
	...
	public function index()
	{
		...
		$this->template->load('v_template_admin', 'pengurus/imam/v_imam', $data);
	}
    ...
    public function tambah()
    {
        ...
        if ($this->form_validation->run() == FALSE) {
		    ...
		    $this->template->load('v_template_admin', 'pengurus/imam/v_tambah', $data);
        } else {
    ...
    public function edit($id_imam) {
        ...
        $this->template->load('v_template_admin', 'pengurus/imam/v_edit', $data);
    }
