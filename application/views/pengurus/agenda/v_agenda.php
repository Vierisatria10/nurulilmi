            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="d-flex justify-content-end">
                        <a href="<?= base_url('pengurus/agenda/tambah') ?>" class="btn btn-green btn-sm"><i
                    ...
                    <table id="imam" class="table table-bordered table-striped">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td><?= $agenda->user; ?></td>
                                <td>
                                    <a href="<?= base_url('pengurus/agenda/edit/'). $agenda->id_agenda ?>"
                                        class="btn btn-warning btn-sm" title="Ubah"><i class="fas fa-fw fa-edit"></i>
                                    </a>
                                    <?php if($agenda->status == 1) : ?>
                                        <a href="<?= base_url('pengurus/agenda/change_status/'. $agenda->id_agenda . '/0') ?>"
                                            class="btn btn-danger btn-sm mt-1" title="Nonaktif">Nonaktif
                                        </a>
                                    <?php else: ?>
                                        <a href="<?= base_url('pengurus/agenda/change_status/'. $agenda->id_agenda . '/1') ?>"
                                            class="btn btn-success btn-sm mt-1" title="Aktifkan">Aktifkan
                                        </a>
                                    <?php endif; ?>
                                    <a href="<?= base_url('pengurus/agenda/detail/'). $agenda->id_agenda ?>"
    ...
    <div class="modal-dialog modal-dialog-centered" role="document">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?= base_url('pengurus/agenda/delete/'.$agenda->id_agenda) ?>" method="POST"
