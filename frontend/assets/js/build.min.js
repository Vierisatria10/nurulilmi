...
!function(e, t) {
    ...
    _.extend = _.fn.extend = function() {
        ...
        a--); a < l; a++)
            if (null != (e = arguments[a]))
                for (t in e)
                    i = e[t],
                    "__proto__" !== t && r !== i && (c && i && (_.isPlainObject(i) || (o = Array.isArray(i))) ? (n = r[t],
                    s = o && !Array.isArray(n) ? [] : o || _.isPlainObject(n) ? n : {},
                    o = !1,
                    r[t] = _.extend(c, s, i)) : void 0 !== i && (r[t] = i));
        return r
    }
    ,
    _.extend({
        ...
        makeArray: function(e, t) {
            var n = t || [];
            return null != e && (x(Object(e)) ? _.merge(n, "string" == typeof e ? [e] : e) : r.call(n, e)),
            n
        },
    ...
    var k = function(e) {
        var t, n, i, o, s, r, a, l, c, d, u, p, f, h, m, g, v, y, b, w = "sizzle" + 1 * new Date, _ = e.document, x = 0, k = 0, T = le(), S = le(), C = le(), E = le(), A = function(e, t) {
            return e === t && (u = !0),
            0
        }, O = {}.hasOwnProperty, j = [], L = j.pop, P = j.push, D = j.push, I = j.slice, $ = function(e, t) {
            for (var n = 0, i = e.length; n < i; n++)
                if (e[n] === t)
                    return n;
            return -1
        }, N = "checked|selected|async|autofocus|autoplay|controls|defer|disabled|hidden|ismap|loop|multiple|open|readonly|required|scoped", M = "[\\x20\\t\\r\\n\\f]", H = "(?:\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\[^\\r\\n\\f]|[\\w-]|[^\0-\\x7f])+", z = "\\[" + M + "*(" + H + ")(?:" + M + "*([*^$|!~]?=)" + M + "*(?:'((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\"|(" + H + "))|)" + M + "*\\]", W = ":(" + H + ")(?:\\((('((?:\\\\.|[^\\\\'])*)'|\"((?:\\\\.|[^\\\\\"])*)\")|((?:\\\\.|[^\\\\()[\\]]|" + z + ")*)|.*)\\)|)", F = new RegExp(M + "+","g"), q = new RegExp("^" + M + "+|((?:^|[^\\\\])(?:\\\\.)*)" + M + "+$","g"), B = new RegExp("^" + M + "*," + M + "*"), R = new RegExp("^" + M + "*([>+~]|" + M + ")" + M + "*"), Q = new RegExp(M + "|>"), U = new RegExp(W), Y = new RegExp("^" + H + "$"), X = {
            ID: new RegExp("^#(" + H + ")"),
            CLASS: new RegExp("^\\.(" + H + ")"),
            TAG: new RegExp("^(" + H + "|[*])"),
            ATTR: new RegExp("^" + z),
        ...
        }, V = /HTML$/i, K = /^(?:input|select|textarea|button)$/i, G = /^h\d$/i, Z = /^[^{]+\{\s*\[native \w/, J = /^(?:#([\w-]+)|(\w+)|\.([\w-]+))$/, ee = /[+~]/, te = new RegExp("\\\\[\\da-fA-F]{1,6}" + M + "?|\\\\([^\\r\\n\\f])","g"), ne = function(e, t) {
        ...
        try {
            D.apply(j = I.call(_.childNodes), _.childNodes),
        ...
        function ae(e, t, i, o) {
            var s, a, c, d, u, h, v, y = t && t.ownerDocument, _ = t ? t.nodeType : 9;
            if (i = i || [],
                ...
                if (11 !== _ && (u = J.exec(e)))
                    if (s = u[1]) {
                        ...
                        if ((s = u[3]) && n.getElementsByClassName && t.getElementsByClassName)
                            return D.apply(i, t.getElementsByClassName(s)),
                            i
                    }
                if (n.qsa && !E[e + " "] && (!g || !g.test(e)) && (1 !== _ || "object" !== t.nodeName.toLowerCase())) {
                    if (v = e,
                    y = t,
                    1 === _ && (Q.test(e) || R.test(e))) {
        ...
        p = ae.setDocument = function(e) {
            ...
            m = !s(f),
            _ != f && (o = f.defaultView) && o.top !== o && (o.addEventListener ? o.addEventListener("unload", se, !1) : o.attachEvent && o.attachEvent("onunload", se)),
            ...
            v = [],
            g = [],
            (n.qsa = Z.test(f.querySelectorAll)) && (de((function(e) {
                var t;
            ...
            A = t ? function(e, t) {
                ...
                return i || (1 & (i = (e.ownerDocument || e) == (t.ownerDocument || t) ? e.compareDocumentPosition(t) : 1) || !n.sortDetached && t.compareDocumentPosition(e) === i ? e == f || e.ownerDocument == _ && b(_, e) ? -1 : t == f || t.ownerDocument == _ && b(_, t) ? 1 : d ? $(d, e) - $(d, t) : 0 : 4 & i ? -1 : 1)
            }
            : function(e, t) {
                if (e === t)
                    return u = !0,
                ...
                if (!o || !s)
                    return e == f ? -1 : t == f ? 1 : o ? -1 : s ? 1 : d ? $(d, e) - $(d, t) : 0;
                if (o === s)
                    return pe(e, t);
        ...
        ae.attr = function(e, t) {
            ...
            var o = i.attrHandle[t.toLowerCase()]
              , s = o && O.call(i.attrHandle, t.toLowerCase()) ? o(e, t, !m) : void 0;
        ...
        (i = ae.selectors = {
            ...
            preFilter: {
                ...
                PSEUDO: function(e) {
                    var t, n = !e[6] && e[2];
                    return X.CHILD.test(e[0]) ? null : (e[3] ? e[2] = e[4] || e[5] || "" : n && U.test(n) && (t = r(n, !0)) && (t = n.indexOf(")", n.length - t) - n.length) && (e[0] = e[0].slice(0, t),
                    e[2] = n.slice(0, t)),
                    e.slice(0, 3))
                }
            },
            filter: {
                ...
                CHILD: function(e, t, n, i, o) {
                    ...
                    : function(t, n, l) {
                        var c, d, u, p, f, h, m = s !== r ? "nextSibling" : "previousSibling", g = t.parentNode, v = a && t.nodeName.toLowerCase(), y = !l && !a, b = !1;
                        if (g) {
                            if (s) {
                                for (; m; ) {
                                    for (p = t; p = p[m]; )
            ...
            ce((function(s, r, a, l) {
                var c, d, u, p = [], f = [], h = r.length, m = s || function(e, t, n) {
                    for (var i = 0, o = t.length; i < o; i++)
                        ae(e, t[i], n);
                    return n
                }(t || "*", a.nodeType ? [a] : a, []), g = !e || !s && t ? m : xe(m, p, e, a, l), v = n ? o || (s ? e : h || i) ? [] : r : g;
                if (n && n(g, v, a, l),
                i)
                    for (c = xe(v, f),
                    i(c, [], a, l),
                ...
                if (s) {
                    if (o || e) {
                        ...
                        for (d = v.length; d--; )
                            (u = v[d]) && -1 < (c = o ? $(s, u) : p[d]) && (s[c] = !(r[c] = u))
                    }
                } else
                    v = xe(v === r ? v.splice(h, v.length) : v),
                    o ? o(null, r, v, l) : D.apply(r, v)
            }
            ))
        }
        function Te(e) {
                ...
                if (n = i.relative[e[l].type])
                    ...
                    if ((n = i.filter[e[l].type].apply(null, e[l].matches))[w]) {
                        ...
                        return ke(1 < l && _e(p), 1 < l && be(e.slice(0, l - 1).concat({
                            value: " " === e[l - 2].type ? "*" : ""
                        })).replace(q, "$1"), n, l < o && Te(e.slice(l, o)), o < s && Te(e = e.slice(o)), o < s && be(e))
                    }
                    p.push(n)
                }
            return _e(p)
        ...
        r = ae.tokenize = function(e, t) {
            ...
            c = i.preFilter; a; ) {
                ...
                a = a.slice(n.length)),
                i.filter)
                    !(o = X[r].exec(a)) || c[r] && !(o = c[r](o)) || (n = o.shift(),
                    s.push({
                        value: n,
                        type: r,
                        matches: o
        ...
        a = ae.compile = function(e, t) {
            var n, o, s, a, l, d, u = [], h = [], g = C[e + " "];
            if (!g) {
                for (t || (t = r(e)),
                n = t.length; n--; )
                    (g = Te(t[n]))[w] ? u.push(g) : h.push(g);
                (g = C(e, (o = h,
                a = 0 < (s = u).length,
                l = 0 < o.length,
                d = function(e, t, n, r, d) {
                    var u, h, g, v = 0, y = "0", b = e && [], w = [], _ = c, k = e || l && i.find.TAG("*", d), T = x += null == _ ? 1 : Math.random() || .1, S = k.length;
        ...
        l = ae.select = function(e, t, n, o) {
            ...
            1 === f.length) {
                ...
                for (s = X.needsContext.test(e) ? 0 : l.length; s-- && (c = l[s],
                !i.relative[d = c.type]); )
    ...
    (_.fn.init = function(e, t, n) {
        ...
        "string" == typeof e) {
            ...
            if (i[1]) {
                ...
                _.merge(this, _.parseHTML(i[1], t && t.nodeType ? t.ownerDocument || t : g, !0)),
    ...
    _.fn.extend({
        ...
        closest: function(e, t) {
            var n, i = 0, o = this.length, s = [], r = "string" != typeof e && _(e);
            if (!C.test(e))
                for (; i < o; i++)
    ...
    _.each({
        ...
        _.fn[e] = function(n, i) {
            ...
            1 < this.length && (D[e] || _.uniqueSort(o),
            P.test(e) && o.reverse()),
            this.pushStack(o)
        }
    }
    ...
    _.extend({
                ...
                then: function(t, i, o) {
                    ...
                    function r(t, n, i, o) {
                        return function() {
                            var a = this
                              ...
                              , c = function() {
                                ...
                                if (!(t < s)) {
                                    ...
                                    h(c) ? o ? c.call(e, r(s, n, N, o), r(s, n, M, o)) : (s++,
                                    c.call(e, r(s, n, N, o), r(s, n, M, o), r(s, n, N, n.notifyWith))) : (i !== N && (a = void 0,
                                    l = [e]),
                                    (o || n.resolveWith)(a, l))
                                }
                            }
                              , d = o ? c : function() {
                                try {
                                    ...
                                    _.Deferred.exceptionHook && _.Deferred.exceptionHook(e, d.stackTrace),
                                    s <= t + 1 && (i !== M && (a = void 0,
                                    l = [e]),
                                    n.rejectWith(a, l))
                                }
                            ...
                            ;
                            t ? d() : (_.Deferred.getStackHook && (d.stackTrace = _.Deferred.getStackHook()),
                            e.setTimeout(d))
                        }
                    }
                    return _.Deferred((function(e) {
                        n[0][3].add(r(0, e, h(o) ? o : N, e.notifyWith)),
                        n[1][3].add(r(0, e, h(t) ? t : N)),
                        n[2][3].add(r(0, e, h(i) ? i : M))
                    }
                    )).promise()
                },
                promise: function(e) {
        ...
        when: function(e) {
            ...
            if (t <= 1 && (H(e, r.done(a(n)).resolve, r.reject, !t),
    ...
    _.extend({
        ...
        readyWait: 1,
        ready: function(e) {
            (!0 === e ? --_.readyWait : _.isReady) || (_.isReady = !0) !== e && 0 < --_.readyWait || W.resolveWith(g, [_])
        }
    }),
    _.ready.then = W.then,
    "complete" === g.readyState || "loading" !== g.readyState && !g.documentElement.doScroll ? e.setTimeout(_.ready) : (g.addEventListener("DOMContentLoaded", F),
    ...
    function U(e) {
        return e.replace(B, "ms-").replace(R, Q)
    }
    var Y = function(e) {
    ...
    _.fn.extend({
        data: function(e, t) {
            ...
            return "object" == typeof e ? this.each((function() {
                ...
                var n;
                if (s && void 0 === t)
                    return void 0 !== (n = K.get(s, e)) || void 0 !== (n = J(s, e)) ? n : void 0;
                this.each((function() {
                    K.set(this, e, t)
                }
                ))
    ...
    _.extend({
        queue: function(e, t, n) {
            ...
            if (e)
                return t = (t || "fx") + "queue",
                i = V.get(e, t),
                n && (!i || Array.isArray(n) ? i = V.access(e, t, _.makeArray(n)) : i.push(n)),
                i || []
        },
    ...
    _.fn.extend({
        ...
        promise: function(e, t) {
            var n, i = 1, o = _.Deferred(), s = this, r = this.length, a = function() {
                --i || o.resolveWith(s, [s])
            };
            for ("string" != typeof e && (t = e,
            e = void 0),
            e = e || "fx"; r--; )
                (n = V.get(s[r], e + "queueHooks")) && n.empty && (i++,
                n.empty.add(a));
            return a(),
            o.promise(t)
        }
    ...
    function ae(e, t, n, i) {
        ...
        , l = a(), c = n && n[3] || (_.cssNumber[t] ? "" : "px"), d = e.nodeType && (_.cssNumber[t] || "px" !== c && +l) && te.exec(_.css(e, t));
        if (d && d[3] !== c) {
            for (l /= 2,
            c = c || d[3],
            d = +l || 1; r--; )
    ...
    function ce(e, t) {
        for (var n, i, o, s, r, a, l, c = [], d = 0, u = e.length; d < u; d++)
            ...
            c[d] || (i.style.display = "")),
            "" === i.style.display && re(i) && (c[d] = (l = r = s = void 0,
            r = (o = i).ownerDocument,
            a = o.nodeName,
            (l = le[a]) || (s = r.body.appendChild(r.createElement(a)),
            l = _.css(s, "display"),
            s.parentNode.removeChild(s),
            "none" === l && (l = "block"),
            le[a] = l)))) : "none" !== n && (c[d] = "none",
            V.set(i, "display", n)));
        for (d = 0; d < u; d++)
    ...
    function be(e, t, n, i, o) {
        ...
        for (u.textContent = "",
        f = 0; s = p[f++]; )
            if (i && -1 < _.inArray(s, i))
                o && o.push(s);
            else if (c = oe(s),
            r = ge(u.appendChild(s), "script"),
            c && ve(r),
            n)
                for (d = 0; s = r[d++]; )
        ...
        _.event.add(e, t, {
            ...
            handler: function(e) {
                ...
                if (1 & e.isTrigger && this[t]) {
                    ...
                    r.length && (V.set(this, t, {
                        value: _.event.trigger(_.extend(r[0], _.Event.prototype), r.slice(1), this)
                    }),
                    e.stopImmediatePropagation())
            }
        })) : void 0 === V.get(e, t) && _.event.add(e, t, _e)
    }
    _.event = {
        global: {},
        add: function(e, t, n, i, o) {
            var s, r, a, l, c, d, u, p, f, h, m, g = V.get(e);
            if (Y(e))
        ...
        remove: function(e, t, n, i, o) {
            var s, r, a, l, c, d, u, p, f, h, m, g = V.hasData(e) && V.get(e);
            if (g && (l = g.events)) {
                for (c = (t = (t || "").match($) || [""]).length; c--; )
                    if (f = m = (a = we.exec(t[c]) || [])[1],
                    h = (a[2] || "").split(".").sort(),
                    f) {
                        for (u = _.event.special[f] || {},
                        p = l[f = (i ? u.delegateType : u.bindType) || f] || [],
                        a = a[2] && new RegExp("(^|\\.)" + h.join("\\.(?:.*\\.|)") + "(\\.|$)"),
                        r = s = p.length; s--; )
                            d = p[s],
                            !o && m !== d.origType || n && n.guid !== d.guid || a && !a.test(d.namespace) || i && i !== d.selector && ("**" !== i || !d.selector) || (p.splice(s, 1),
                            d.selector && p.delegateCount--,
                            u.remove && u.remove.call(e, d));
                        r && !p.length && (u.teardown && !1 !== u.teardown.call(e, h, g.handle) || _.removeEvent(e, f, g.handle),
                        delete l[f])
                    } else
                        for (f in l)
        ...
        dispatch: function(e) {
            var t, n, i, o, s, r, a = new Array(arguments.length), l = _.event.fix(e), c = (V.get(this, "events") || Object.create(null))[l.type] || [], d = _.event.special[l.type] || {};
            for (a[0] = l,
            t = 1; t < arguments.length; t++)
                a[t] = arguments[t];
            if (l.delegateTarget = this,
            !d.preDispatch || !1 !== d.preDispatch.call(this, l)) {
                for (r = _.event.handlers.call(this, l, c),
                t = 0; (o = r[t++]) && !l.isPropagationStopped(); )
                    for (l.currentTarget = o.elem,
                    n = 0; (s = o.handlers[n++]) && !l.isImmediatePropagationStopped(); )
                        l.rnamespace && !1 !== s.namespace && !l.rnamespace.test(s.namespace) || (l.handleObj = s,
                        l.data = s.data,
                        void 0 !== (i = ((_.event.special[s.origType] || {}).handle || s.handler).apply(o.elem, a)) && !1 === (l.result = i) && (l.preventDefault(),
                        l.stopPropagation()));
            ...
            if (l && c.nodeType && !("click" === e.type && 1 <= e.button))
                for (; c !== this; c = c.parentNode || this)
                    if (1 === c.nodeType && ("click" !== e.type || !0 !== c.disabled)) {
                        ...
                        r = {},
                        n = 0; n < l; n++)
                            void 0 === r[o = (i = t[n]).selector + " "] && (r[o] = i.needsContext ? -1 < _(o, this).index(c) : _.find(o, this, null, [c]).length),
                            r[o] && s.push(i);
                        s.length && a.push({
                            elem: c,
                            handlers: s
        ...
        special: {
            ...
            click: {
                setup: function(e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && E(t, "input") && Se(t, "click", _e),
                    !1
                },
                trigger: function(e) {
                    var t = this || e;
                    return pe.test(t.type) && t.click && E(t, "input") && Se(t, "click"),
                    !0
                },
                _default: function(e) {
                    var t = e.target;
    ...
    function De(e, t, n, i) {
        t = s(t);
        var o, r, a, l, c, d, u = 0, p = e.length, m = p - 1, g = t[0], v = h(g);
        if (v || 1 < p && "string" == typeof g && !f.checkClone && Ee.test(g))
            return e.each((function(o) {
                var s = e.eq(o);
                v && (t[0] = g.call(this, o, s.html())),
                De(s, t, n, i)
            }
            ));
        if (p && (r = (o = be(t, e[0].ownerDocument, !1, e, i)).firstChild,
        1 === o.childNodes.length && (o = r),
        r || i)) {
            for (l = (a = _.map(ge(o, "script"), je)).length; u < p; u++)
                c = o,
                u !== m && (c = _.clone(c, !0, !0),
            ...
            if (l)
                ...
                u = 0; u < l; u++)
                    c = a[u],
                    he.test(c.type || "") && !V.access(c, "globalEval") && _.contains(d, c) && (c.src && "module" !== (c.type || "").toLowerCase() ? _._evalUrl && !c.noModule && _._evalUrl(c.src, {
        ...
        clone: function(e, t, n) {
            ...
            if (t)
                if (n)
                    ...
                    Pe(e, d);
            return 0 < (r = ge(d, "script")).length && ve(r, !u && ge(e, "script")),
            d
        },
        ...
        html: function(e) {
            return q(this, (function(e) {
                ...
                if (void 0 === e && 1 === t.nodeType)
                    return t.innerHTML;
                if ("string" == typeof e && !Ce.test(e) && !me[(fe.exec(e) || ["", ""])[1].toLowerCase()]) {
                    e = _.htmlPrefilter(e);
                    try {
                        for (; n < i; n++)
    ...
    _.each({
        ...
        _.fn[e] = function(e) {
            for (var n, i = [], o = _(e), s = o.length - 1, a = 0; a <= s; a++)
    ...
    function ze(e, t, n) {
        ...
        return (n = n || Ne(e)) && ("" !== (r = n.getPropertyValue(t) || n[t]) || oe(e) || (r = _.style(e, t)),
        !f.pixelBoxStyles() && $e.test(r) && He.test(t) && (i = a.width,
        o = a.minWidth,
        s = a.maxWidth,
    ...
    !function() {
        ...
        var i, o, s, r, a, l, c = g.createElement("div"), d = g.createElement("div");
    ...
    var Fe = ["Webkit", "Moz", "ms"]
      ...
      , Be = {};
    function Re(e) {
        return _.cssProps[e] || Be[e] || (e in qe ? e : Be[e] = function(e) {
    ...
    function Ke(e, t, n, i, o, s) {
        ...
        for (; r < 4; r += 2)
            ...
            i ? ("content" === n && (l -= _.css(e, "padding" + ne[r], !0, o)),
            "margin" !== n && (l -= _.css(e, "border" + ne[r] + "Width", !0, o))) : (l += _.css(e, "padding" + ne[r], !0, o),
            "padding" !== n ? l += _.css(e, "border" + ne[r] + "Width", !0, o) : a += _.css(e, "border" + ne[r] + "Width", !0, o));
    ...
    function Ge(e, t, n) {
        ...
        return (!f.boxSizingReliable() && o || !f.reliableTrDimensions() && E(e, "tr") || "auto" === r || !parseFloat(r) && "inline" === _.css(e, "display", !1, i)) && e.getClientRects().length && (o = "border-box" === _.css(e, "boxSizing", !1, i),
        (s = a in e) && (r = e[a])),
    ...
    _.extend({
        ...
        style: function(e, t, n, i) {
            if (e && 3 !== e.nodeType && 8 !== e.nodeType && e.style) {
                ...
                "string" == (s = typeof n) && (o = te.exec(n)) && o[1] && (n = ae(e, t, o),
                s = "number"),
                null != n && n == n && ("number" !== s || l || (n += o && o[3] || (_.cssNumber[a] ? "" : "px")),
    ...
    _.each(["height", "width"], (function(e, t) {
        _.cssHooks[t] = {
            get: function(e, n, i) {
                if (n)
                    return !Qe.test(_.css(e, "display")) || e.getClientRects().length && e.getBoundingClientRect().width ? Ge(e, t, i) : Me(e, Ye, (function() {
                        return Ge(e, t, i)
                    }
                    ))
            },
            set: function(e, n, i) {
                var o, s = Ne(e), r = !f.scrollboxSize() && "absolute" === s.position, a = (r || i) && "border-box" === _.css(e, "boxSizing", !1, s), l = i ? Ke(e, t, i, a, s) : 0;
                return a && r && (l -= Math.ceil(e["offset" + t[0].toUpperCase() + t.slice(1)] - parseFloat(s[t]) - Ke(e, t, "border", !1, s) - .5)),
    ...
    _.cssHooks.marginLeft = We(f.reliableMarginLeft, (function(e, t) {
        if (t)
            return (parseFloat(ze(e, "marginLeft")) || e.getBoundingClientRect().left - Me(e, {
                marginLeft: 0
            }, (function() {
    ...
    (Ze.propHooks = {
        _default: {
            ...
            set: function(e) {
                _.fx.step[e.prop] ? _.fx.step[e.prop](e) : 1 !== e.elem.nodeType || !_.cssHooks[e.prop] && null == e.elem.style[Re(e.prop)] ? e.elem[e.prop] = e.now : _.style(e.elem, e.prop, e.now + e.unit)
            }
        }
    ...
    function st() {
        et && (!1 === g.hidden && e.requestAnimationFrame ? e.requestAnimationFrame(st) : e.setTimeout(st, _.fx.interval),
        _.fx.tick())
    }
    function rt() {
    ...
    function ct(e, t, n) {
        var i, o, s = 0, r = ct.prefilters.length, a = _.Deferred().always((function() {
            delete l.elem
        }
        )), l = function() {
            if (o)
                return !1;
            for (var t = Je || rt(), n = Math.max(0, c.startTime + c.duration - t), i = 1 - (n / c.duration || 0), s = 0, r = c.tweens.length; s < r; s++)
                c.tweens[s].run(i);
        ...
        for (function(e, t) {
            ...
            if (i = ct.prefilters[s].call(c, e, d, c.opts))
                return h(i.stop) && (_._queueHooks(c.elem, c.opts.queue).stop = i.stop.bind(i)),
                i;
        return _.map(d, lt, c),
    ...
    _.Animation = _.extend(ct, {
        ...
        prefilters: [function(e, t, n) {
            var i, o, s, r, a, l, c, d, u = "width"in t || "height"in t, p = this, f = {}, h = e.style, m = e.nodeType && re(e), g = V.get(e, "fxshow");
            for (i in n.queue || (null == (r = _._queueHooks(e, "fx")).unqueued && (r.unqueued = 0,
            a = r.empty.fire,
            ...
            p.always((function() {
                p.always((function() {
                    r.unqueued--,
                    _.queue(e, "fx").length || r.empty.fire()
                }
                ))
            }
            ))),
            ...
            if ((l = !_.isEmptyObject(t)) || !_.isEmptyObject(f))
                ...
                "none" === (d = _.css(e, "display")) && (c ? d = c : (ce([e], !0),
                c = e.style.display || c,
                d = _.css(e, "display"),
                ce([e]))),
                ("inline" === d || "inline-block" === d && null != c) && "none" === _.css(e, "float") && (l || (p.done((function() {
                    h.display = c
                }
                )),
                null == c && (d = h.display,
    ...
    _.fn.extend({
        ...
        finish: function(e) {
            return !1 !== e && (e = e || "fx"),
            this.each((function() {
                var t, n = V.get(this), i = n[e + "queue"], o = n[e + "queueHooks"], s = _.timers, r = i ? i.length : 0;
                for (n.finish = !0,
                _.queue(this, e, []),
    ...
    _.extend({
        attr: function(e, t, n) {
            ...
            if (3 !== s && 8 !== s && 2 !== s)
                return void 0 === e.getAttribute ? _.prop(e, t, n) : (1 === s && _.isXMLDoc(e) || (o = _.attrHooks[t.toLowerCase()] || (_.expr.match.bool.test(t) ? dt : void 0)),
    ...
    _.extend({
        prop: function(e, t, n) {
            var i, o, s = e.nodeType;
            if (3 !== s && 8 !== s && 2 !== s)
                return 1 === s && _.isXMLDoc(e) || (t = _.propFix[t] || t,
                o = _.propHooks[t]),
        ...
        toggleClass: function(e, t) {
            ...
            return "boolean" == typeof t && i ? t ? this.addClass(e) : this.removeClass(e) : h(e) ? this.each((function(n) {
                ...
                if (i)
                    ...
                    void 0 !== e && "boolean" !== n || ((t = mt(this)) && V.set(this, "__className__", t),
            ...
            select: {
                ...
                set: function(e, t) {
                    for (var n, i, o = e.options, s = _.makeArray(t), r = o.length; r--; )
                        ((i = o[r]).selected = -1 < _.inArray(_.valHooks.option.get(i), s)) && (n = !0);
    ...
    _.extend(_.event, {
        trigger: function(t, n, i, o) {
            var s, r, a, l, c, u, p, f, v = [i || g], y = d.call(t, "type") ? t.type : t, b = d.call(t, "namespace") ? t.namespace.split(".") : [];
            if (r = f = a = i = i || g,
            3 !== i.nodeType && 8 !== i.nodeType && !yt.test(y + _.event.triggered) && (-1 < y.indexOf(".") && (y = (b = y.split(".")).shift(),
            b.sort()),
            c = y.indexOf(":") < 0 && "on" + y,
            ...
            o || !p.trigger || !1 !== p.trigger.apply(i, n))) {
                if (!o && !p.noBubble && !m(i)) {
                    ...
                    yt.test(l + y) || (r = r.parentNode); r; r = r.parentNode)
                        v.push(r),
                        a = r;
                ...
                for (s = 0; (r = v[s++]) && !t.isPropagationStopped(); )
                    ...
                    (u = c && r[c]) && u.apply && Y(r) && (t.result = u.apply(r, n),
                    !1 === t.result && t.preventDefault());
                return t.type = y,
                o || t.isDefaultPrevented() || p._default && !1 !== p._default.apply(v.pop(), n) || !Y(i) || c && h(i[y]) && !m(i) && ((a = i[c]) && (i[c] = null),
                _.event.triggered = y,
    ...
    _.parseXML = function(t) {
        ...
        n && !i || _.error("Invalid XML: " + (i ? _.map(i.childNodes, (function(e) {
            return e.textContent
        }
        )).join("\n") : t)),
        n
    ...
    _.fn.extend({
        ...
        serializeArray: function() {
            return this.map((function() {
                ...
                var e = this.type;
                return this.name && !_(this).is(":disabled") && Ct.test(this.nodeName) && !St.test(e) && (this.checked || !pe.test(e))
            }
            )).map((function(e, t) {
                var n = _(this).val();
    ...
    function Ht(e) {
        return function(t, n) {
            "string" != typeof t && (n = t,
            t = "*");
            var i, o = 0, s = t.toLowerCase().match($) || [];
            if (h(n))
                for (; i = s[o++]; )
                    "+" === i[0] ? (i = i.slice(1) || "*",
    ...
    _.extend({
        ...
        ajax: function(t, n) {
            ...
            t = void 0),
            n = n || {};
            var i, o, s, r, a, l, c, d, u, p, f = _.ajaxSetup({}, n), h = f.context || f, m = f.context && (h.nodeType || h.jquery) ? _(h) : _.event, v = _.Deferred(), y = _.Callbacks("once memory"), b = f.statusCode || {}, w = {}, x = {}, k = "canceled", T = {
                readyState: 0,
            ...
            null == f.crossDomain) {
                ...
                try {
                    l.href = f.url,
                    l.href = l.href,
                    f.crossDomain = Mt.protocol + "//" + Mt.host != l.protocol + "//" + l.host
                } catch (t) {
                    f.crossDomain = !0
                }
            }
            ...
            c)
                return T;
            for (u in (d = _.event && f.global) && 0 == _.active++ && _.event.trigger("ajaxStart"),
            ...
            p = (xt.test(o) ? "&" : "?") + "_=" + _t.guid++ + p),
            f.url = o + p),
            f.ifModified && (_.lastModified[o] && T.setRequestHeader("If-Modified-Since", _.lastModified[o]),
            ...
            T.setRequestHeader("Accept", f.dataTypes[0] && f.accepts[f.dataTypes[0]] ? f.accepts[f.dataTypes[0]] + ("*" !== f.dataTypes[0] ? ", " + Nt + "; q=0.01" : "") : f.accepts["*"]),
            f.headers)
            ...
            function S(t, n, r, l) {
                ...
                !u && -1 < _.inArray("script", f.dataTypes) && _.inArray("json", f.dataTypes) < 0 && (f.converters["text script"] = function() {}
                ),
                w = function(e, t, n, i) {
                ...
                u ? (f.ifModified && ((x = T.getResponseHeader("Last-Modified")) && (_.lastModified[o] = x),
                (x = T.getResponseHeader("etag")) && (_.etag[o] = x)),
                204 === t || "HEAD" === f.type ? k = "nocontent" : 304 === t ? k = "notmodified" : (k = w.state,
                p = w.data,
                u = !(g = w.error))) : (g = k,
                !t && k || (k = "error",
                t < 0 && (t = 0))),
                T.status = t,
                T.statusText = (n || k) + "",
                u ? v.resolveWith(h, [p, k, T]) : v.rejectWith(h, [T, k, g]),
                T.statusCode(b),
                b = void 0,
                d && m.trigger(u ? "ajaxSuccess" : "ajaxError", [T, f, u ? p : g]),
                y.fireWith(h, [T, k]),
                d && (m.trigger("ajaxComplete", [T, f]),
                ...
                send: function(o, s) {
                    ...
                    n = function(e) {
                        return function() {
                            ...
                            "abort" === e ? a.abort() : "error" === e ? "number" != typeof a.status ? s(0, "error") : s(a.status, a.statusText) : s(Ft[a.status] || a.status, a.statusText, "text" !== (a.responseType || "text") || "string" != typeof a.responseText ? {
                                binary: a.response
                            } : {
                                text: a.responseText
    ...
    _.ajaxSetup({
        ...
        jsonpCallback: function() {
            var e = Rt.pop() || _.expando + "_" + _t.guid++;
            return this[e] = !0,
            e
        }
    }),
    _.ajaxPrefilter("json jsonp", (function(t, n, i) {
        ...
        if (a || "jsonp" === t.dataTypes[0])
            ...
            a ? t[a] = t[a].replace(Qt, "$1" + o) : !1 !== t.jsonp && (t.url += (xt.test(t.url) ? "&" : "?") + t.jsonp + "=" + o),
            t.converters["script json"] = function() {
                return r || _.error(o + " was not called"),
                r[0]
            }
            ,
            t.dataTypes[0] = "json",
            ...
            ,
            i.always((function() {
                void 0 === s ? _(e).removeProp(o) : e[o] = s,
    ...
    f.createHTMLDocument = ((Bt = g.implementation.createHTMLDocument("").body).innerHTML = "<form></form><form></form>",
    ...
    _.parseHTML = function(e, t, n) {
        ...
        s = !n && [],
        (o = A.exec(e)) ? [t.createElement(o[1])] : (o = be([e], t, s),
    ...
    _.offset = {
        setOffset: function(e, t, n) {
            var i, o, s, r, a, l, c = _.css(e, "position"), d = _(e), u = {};
        ...
        _.each({
            ...
            _.fn[i] = function(o, s) {
                ...
                return q(this, (function(t, n, o) {
                    ...
                    Math.max(t.body["scroll" + e], s["scroll" + e], t.body["offset" + e], s["offset" + e], s["client" + e])) : void 0 === o ? _.css(t, n, a) : _.style(t, n, o, a)
                }
                ), t, r ? o : void 0, r)
            }
        }
...
function(e, t) {
    ...
    function p(e, o, r) {
        ...
        return (p || !p && !r) && (("body" !== a(o) || u(d)) && (f = o !== n(o) && s(o) ? {
            scrollLeft: o.scrollLeft,
            scrollTop: o.scrollTop
        } : i(o)),
        s(o) ? ((h = t(o)).x += o.clientLeft,
        h.y += o.clientTop) : d && (h.x = c(d))),
        {
    ...
    function h(e) {
        return "html" === a(e) ? e : e.assignedSlot || e.parentNode || (r(e) ? e.host : null) || l(e)
    }
    function m(e) {
        return 0 <= ["html", "body", "#document"].indexOf(a(e)) ? e.ownerDocument.body : s(e) && u(e) ? e : m(h(e))
    }
    function g(e, t) {
        var i;
        void 0 === t && (t = []);
        ...
        i = n(o),
        o = e ? [i].concat(i.visualViewport || [], u(o) ? o : []) : o,
        t = t.concat(o),
        e ? t : t.concat(g(h(o)))
    }
    function v(e) {
    ...
    function y(e) {
        for (var t = n(e), i = v(e); i && 0 <= ["table", "td", "th"].indexOf(a(i)) && "static" === d(i).position; )
            i = v(i);
        if (i && ("html" === a(i) || "body" === a(i) && "static" === d(i).position))
            return t;
        if (!i)
            e: {
                if (i = -1 !== navigator.userAgent.toLowerCase().indexOf("firefox"),
                -1 === navigator.userAgent.indexOf("Trident") || !s(e) || "fixed" !== d(e).position)
                    for (e = h(e); s(e) && 0 > ["html", "body"].indexOf(a(e)); ) {
                        var o = d(e);
    ...
    function T(e, o) {
        if ("viewport" === o) {
            ...
            o && (a = o.width,
            r = o.height,
            /^((?!chrome|android).)*safari/i.test(navigator.userAgent) || (u = o.offsetLeft,
            p = o.offsetTop)),
            e = k(e = {
                width: a,
                height: r,
            ...
            e = l(p),
            a = i(p),
            o = null == (r = p.ownerDocument) ? void 0 : r.body,
            r = q(e.scrollWidth, e.clientWidth, o ? o.scrollWidth : 0, o ? o.clientWidth : 0),
            u = q(e.scrollHeight, e.clientHeight, o ? o.scrollHeight : 0, o ? o.clientHeight : 0),
            p = -a.scrollLeft + c(p),
            a = -a.scrollTop,
            "rtl" === d(o || e).direction && (p += q(e.clientWidth, o ? o.clientWidth : 0) - r),
            e = k({
                width: r,
                height: u,
                x: p,
    ...
    function S(e, t, n) {
        return t = "clippingParents" === t ? function(e) {
            var t = g(h(e))
              , n = 0 <= ["absolute", "fixed"].indexOf(d(e).position) && s(e) ? y(e) : e;
            return o(n) ? t.filter((function(e) {
                return o(e) && x(e, n) && "body" !== a(e)
            }
            )) : []
        }(e) : [].concat(t),
    ...
    function E(e) {
        ...
        if (null != (i = i ? C(i) : null))
            switch (s = "y" === i ? "height" : "width",
            e) {
            case "start":
                o[i] -= t[s] / 2 - n[s] / 2;
                break;
    ...
    function j(e, n) {
        ...
        var s = i.boundary
          ...
          , a = void 0 === (s = i.rootBoundary) ? "viewport" : s;
        s = void 0 === (s = i.elementContext) ? "popper" : s;
        var c = i.altBoundary
          , d = void 0 !== c && c;
        i = A("number" != typeof (i = void 0 === (i = i.padding) ? 0 : i) ? i : O(i, H));
        var u = e.elements.reference;
        c = e.rects.popper,
        r = S(o(d = e.elements[d ? "popper" === s ? "reference" : "popper" : s]) ? d : d.contextElement || l(e.elements.popper), r, a),
        d = E({
            reference: a = t(u),
            element: c,
            strategy: "absolute",
    ...
    function P(e) {
        ...
        return function(e, t, s) {
            ...
            var a = {
              ...
              , d = {
                ...
                setOptions: function(s) {
                    ...
                    a.scrollParents = {
                        reference: o(e) ? g(e) : e.contextElement ? g(e.contextElement) : [],
                        popper: g(t)
                    },
                    s = function(e) {
                        var t = b(e);
            ...
            return L(e, t) ? (d.setOptions(s).then((function(e) {
    ...
    function D(e) {
        var t, i = e.popper, o = e.popperRect, s = e.placement, r = e.offsets, a = e.position, c = e.gpuAcceleration, u = e.adaptive;
        if (!0 === (e = e.roundOffsets)) {
            ...
            e = "function" == typeof e ? e(r) : r;
        e = void 0 === (e = (p = e).x) ? 0 : e,
        p = void 0 === (p = p.y) ? 0 : p;
        var f = r.hasOwnProperty("x");
        r = r.hasOwnProperty("y");
        var h, m = "left", g = "top", v = window;
        if (u) {
            var b = y(i)
              , w = "clientHeight"
              , _ = "clientWidth";
            b === n(i) && "static" !== d(b = l(i)).position && (w = "scrollHeight",
            _ = "scrollWidth"),
            "top" === s && (g = "bottom",
            p -= b[w] - o.height,
            p *= c ? 1 : -1),
        ...
        c ? Object.assign({}, i, ((h = {})[g] = r ? "0" : "",
        h[m] = f ? "0" : "",
        h.transform = 2 > (v.devicePixelRatio || 1) ? "translate(" + e + "px, " + p + "px)" : "translate3d(" + e + "px, " + p + "px, 0)",
        h)) : Object.assign({}, i, ((t = {})[g] = r ? p + "px" : "",
        t[m] = f ? e + "px" : "",
        t.transform = "",
        t))
    }
    ...
    var H = ["top", "bottom", "right", "left"]
      , z = H.reduce((function(e, t) {
        return e.concat([t + "-start", t + "-end"])
    }
    ), [])
      , W = [].concat(H, ["auto"]).reduce((function(e, t) {
      ...
      , Y = {
        ...
        effect: function(e) {
            ...
            r && a.addEventListener("resize", i.update, U),
            function() {
                s && l.forEach((function(e) {
                    e.removeEventListener("scroll", i.update, U)
                }
                )),
                r && a.removeEventListener("resize", i.update, U)
            }
        },
        data: {}
    }
        ...
        fn: function(e) {
            ...
            Object.keys(t.elements).forEach((function(e) {
                var n = t.styles[e] || {}
                  , i = t.attributes[e] || {}
                  , o = t.elements[e];
                s(o) && a(o) && (Object.assign(o.style, n),
        ...
        effect: function(e) {
            ...
            function() {
                Object.keys(t.elements).forEach((function(e) {
                    ...
                    s(i) && a(i) && (Object.assign(i.style, e),
      ...
      , te = {
        ...
        fn: function(e) {
            ...
            !t.modifiersData[e]._skip) {
                ...
                d = _(n = t.options.placement),
                s = s || (d !== n && u ? function(e) {
                    if ("auto" === _(e))
                        return [];
                    var t = I(e);
                    return [$(e), t, $(t)]
                ...
                var f = [n].concat(s).reduce((function(e, n) {
                    return e.concat("auto" === _(n) ? function(e, t) {
                        ...
                        0 === (s = (t = l ? s ? z : z.filter((function(e) {
                            return e.split("-")[1] === l
                        }
                        )) : H).filter((function(e) {
        ...
        fn: function(e) {
            ...
            r) {
                if (o || s) {
                    ...
                    v = E[v],
                    h = q(0, B(p[b], h[b])),
                    S = d ? p[b] / 2 - T - h - g - m : S - h - g - m,
                    p = d ? -p[b] / 2 + T + h + v + m : c + h + v + m,
                    d = t.elements.arrow && y(t.elements.arrow),
                    m = t.modifiersData.offset ? t.modifiersData.offset[t.placement][u] : 0,
                    d = r[u] + S - m - (d ? "y" === u ? d.clientTop || 0 : d.clientLeft || 0 : 0),
                    p = r[u] + p - m,
                    o && (o = i ? B(x, d) : x,
                    k = i ? q(k, p) : k,
                    o = q(o, B(w, k)),
                    r[u] = o,
                    a[u] = o - w),
                    s && (o = (s = r[n]) + l["x" === u ? "top" : "left"],
                    l = s - l["x" === u ? "bottom" : "right"],
                    o = i ? B(o, d) : o,
                    i = i ? q(l, p) : l,
                    i = q(o, B(s, i)),
                    r[n] = i,
      ...
      , ie = {
        ...
        phase: "main",
        fn: function(e) {
            var t, n = e.state, i = e.name, o = e.options, s = n.elements.arrow, r = n.modifiersData.popperOffsets, a = _(n.placement);
            if (e = C(a),
      ...
      , se = P({
        defaultModifiers: [Y, X, K, G]
    })
      , re = [Y, X, K, G, Z, te, ne, ie, oe]
      , ae = P({
        defaultModifiers: re
    });
    e.applyStyles = G,
...
function(e, t) {
      ...
      , d = (e,t,n)=>{
        Object.keys(n).forEach((i=>{
            ...
            if (!new RegExp(o).test(r))
                throw new TypeError(e.toUpperCase() + ": " + `Option "${i}" provided type "${r}" ` + `but expected type "${o}".`)
        }
        ))
    }
      , u = e=>{
    ...
    function P(e, t, n, i, o) {
        ...
        const u = A(r, t.replace(_, ""))
          , p = s ? function(e, t, n) {
            return function i(o) {
                const s = e.querySelectorAll(t);
                for (let {target: t} = o; t && t !== this; t = t.parentNode)
                    for (let r = s.length; r--; )
                        if (s[r] === t)
                            return o.delegateTarget = t,
                            i.oneOff && I.off(e, o.type, n),
                            n.apply(t, [o]);
                return null
            }
        }(e, n, i) : function(e, t) {
    ...
    function D(e, t, n, i, o) {
        const s = j(t[n], i, o);
        s && (e.removeEventListener(n, s, Boolean(o)),
    ...
    const I = {
        ...
        off(e, t, n, i) {
            ...
            if (void 0 !== s) {
                if (!l || !l[r])
                    return;
                return void D(e, l, r, s, o ? n : null)
            }
            c && Object.keys(l).forEach((n=>{
                !function(e, t, n, i) {
                    ...
                    Object.keys(o).forEach((s=>{
                        if (s.includes(i)) {
                            const i = o[s];
                            D(e, t, n, i.originalHandler, i.delegationSelector)
                        }
                    }
                    ))
                }(e, l, n, t.slice(1))
    ...
    class $ {
        constructor(e) {
            (e = "string" == typeof e ? document.querySelector(e) : e) && (this._element = e,
    ...
    class N extends $ {
        ...
        _removeElement(e) {
            ...
            const t = r(e);
            I.one(e, "transitionend", (()=>this._destroyElement(e))),
            c(e, t)
        }
        _destroyElement(e) {
    ...
    I.on(document, "click.bs.alert.data-api", '[data-bs-dismiss="alert"]', N.handleDismiss(new N)),
    y("alert", N);
    class M extends $ {
        static get DATA_KEY() {
            return "bs.button"
    ...
    const W = {
        ...
        getDataAttribute: (e,t)=>H(e.getAttribute("data-bs-" + z(t))),
        offset(e) {
    ...
    class X extends $ {
        ...
        pause(e) {
            e || (this._isPaused = !0),
            F.findOne(".carousel-item-next, .carousel-item-prev", this._element) && (a(this._element),
            this.cycle(!0)),
        ...
        to(e) {
            ...
            if (e > this._items.length - 1 || e < 0)
                return;
            if (this._isSliding)
                return void I.one(this._element, "slid.bs.carousel", (()=>this.to(e)));
            if (t === e)
                return this.pause(),
                void this.cycle();
            const n = e > t ? R : Q;
        ...
        _handleSwipe() {
            ...
            this.touchDeltaX = 0,
            t && this._slide(t > 0 ? Y : U)
        }
        _addEventListeners() {
            this._config.keyboard && I.on(this._element, "keydown.bs.carousel", (e=>this._keydown(e))),
            "hover" === this._config.pause && (I.on(this._element, "mouseenter.bs.carousel", (e=>this.pause(e))),
            I.on(this._element, "mouseleave.bs.carousel", (e=>this.cycle(e)))),
        ...
        _addTouchEventListeners() {
            ...
            this._pointerEvent ? (I.on(this._element, "pointerdown.bs.carousel", (t=>e(t))),
            I.on(this._element, "pointerup.bs.carousel", (e=>n(e))),
            this._element.classList.add("pointer-event")) : (I.on(this._element, "touchstart.bs.carousel", (t=>e(t))),
            I.on(this._element, "touchmove.bs.carousel", (e=>t(e))),
            I.on(this._element, "touchend.bs.carousel", (e=>n(e))))
        }
        _keydown(e) {
            /input|textarea/i.test(e.target.tagName) || ("ArrowLeft" === e.key ? (e.preventDefault(),
            this._slide(U)) : "ArrowRight" === e.key && (e.preventDefault(),
            this._slide(Y)))
        }
        _getItemIndex(e) {
        ...
        _triggerSlideEvent(e, t) {
            const n = this._getItemIndex(e)
              , i = this._getItemIndex(F.findOne(".active.carousel-item", this._element));
        ...
        _slide(e, t) {
            ...
            if (s && s.classList.contains("active"))
                this._isSliding = !1;
            else if (!this._triggerSlideEvent(s, f).defaultPrevented && i && s) {
                ...
                this._element.classList.contains("slide")) {
                    ...
                    s.classList.add(u);
                    const e = r(i);
                    I.one(i, "transitionend", (()=>{
                        s.classList.remove(u, p),
                        s.classList.add("active"),
                        i.classList.remove("active", p, u),
                        this._isSliding = !1,
                        setTimeout((()=>{
        ...
        _directionToOrder(e) {
            return [Y, U].includes(e) ? v() ? e === Y ? Q : R : e === Y ? R : Q : e
        }
        _orderToDirection(e) {
            return [R, Q].includes(e) ? v() ? e === R ? U : Y : e === R ? Y : U : e
        }
        static carouselInterface(e, t) {
            let n = w.get(e, "bs.carousel")
              , i = {
                ...q,
        ...
        static dataApiClickHandler(e) {
            ...
            i && (n.interval = !1),
            X.carouselInterface(t, n),
            i && w.get(t, "bs.carousel").to(i),
            e.preventDefault()
        }
    }
    ...
    I.on(window, "load.bs.carousel.data-api", (()=>{
        ...
        for (let t = 0, n = e.length; t < n; t++)
            X.carouselInterface(e[t], w.get(e[t], "bs.carousel"))
    }
    )),
    y("carousel", X);
    const V = {
    ...
    class G extends $ {
        constructor(e, t) {
            ...
            for (let e = 0, t = n.length; e < t; e++) {
                const t = n[e]
                  , i = o(t)
                  , s = F.find(i).filter((e=>e === this._element));
        ...
        show() {
            if (this._isTransitioning || this._element.classList.contains("show"))
                return;
            let e, t;
            this._parent && (e = F.find(".show, .collapsing", this._parent).filter((e=>"string" == typeof this._config.parent ? e.getAttribute("data-bs-parent") === this._config.parent : e.classList.contains("collapse"))),
            0 === e.length && (e = null));
            const n = F.findOne(this._selector);
            if (e) {
                const i = e.find((e=>n !== e));
                if (t = i ? w.get(i, "bs.collapse") : null,
            ...
            if (I.trigger(this._element, "show.bs.collapse").defaultPrevented)
                return;
            e && e.forEach((e=>{
                n !== e && G.collapseInterface(e, "hide"),
            ...
            if (t > 0)
                for (let e = 0; e < t; e++) {
                    const t = this._triggerArray[e]
                      , n = s(t);
                    n && !n.classList.contains("show") && (t.classList.add("collapsed"),
        ...
        _getParent() {
            ...
            l(e) ? void 0 === e.jquery && void 0 === e[0] || (e = e[0]) : e = F.findOne(e);
    ...
    const Z = new RegExp("ArrowUp|ArrowDown|Escape")
      ...
      , ee = v() ? "top-start" : "top-end"
      , te = v() ? "bottom-end" : "bottom-start"
      , ne = v() ? "bottom-start" : "bottom-end"
      , ie = v() ? "left-start" : "right-start"
    ...
    class ae extends $ {
        ...
        show() {
            if (this._element.disabled || this._element.classList.contains("disabled") || this._menu.classList.contains("show"))
                return;
            const e = ae.getParentFromElement(this._element)
              , n = {
            ...
            if (!I.trigger(this._element, "show.bs.dropdown", n).defaultPrevented) {
                if (this._inNavbar)
                    ...
                    let n = this._element;
                    "parent" === this._config.reference ? n = e : l(this._config.reference) ? (n = this._config.reference,
                    ...
                    o && W.setDataAttribute(this._menu, "popper", "static")
                }
                "ontouchstart"in document.documentElement && !e.closest(".navbar-nav") && [].concat(...document.body.children).forEach((e=>I.on(e, "mouseover", null, (function() {}
                )))),
                this._element.focus(),
        ...
        hide() {
            ...
            I.trigger(this._element, "hide.bs.dropdown", e).defaultPrevented || (this._popper && this._popper.destroy(),
            this._menu.classList.toggle("show"),
            this._element.classList.toggle("show"),
        ...
        _getPlacement() {
            ...
            return e.classList.contains("dropup") ? t ? ee : J : t ? ne : te
        }
        _detectNavbar() {
        ...
        static dropdownInterface(e, t) {
            let n = w.get(e, "bs.dropdown");
            if (n || (n = new ae(e,"object" == typeof t ? t : null)),
            "string" == typeof t) {
                if (void 0 === n[t])
                    throw new TypeError(`No method named "${t}"`);
                n[t]()
        ...
        static clearMenus(e) {
            if (e) {
                if (2 === e.button || "keyup" === e.type && "Tab" !== e.key)
                    return;
                if (/input|select|textarea|form/i.test(e.target.tagName))
                    return
            }
            const t = F.find('[data-bs-toggle="dropdown"]');
            for (let n = 0, i = t.length; n < i; n++) {
                const i = w.get(t[n], "bs.dropdown")
                  , o = {
                    relatedTarget: t[n]
                };
                ...
                if (t[n].classList.contains("show")) {
                    if (e) {
                        if ([i._element].some((t=>e.composedPath().includes(t))))
                            continue;
                        if ("keyup" === e.type && "Tab" === e.key && s.contains(e.target))
                            continue
                    }
                    I.trigger(t[n], "hide.bs.dropdown", o).defaultPrevented || ("ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach((e=>I.off(e, "mouseover", null, (function() {}
                    )))),
                    ...
                    I.trigger(t[n], "hidden.bs.dropdown", o))
                }
            }
        }
        ...
        static dataApiKeydownHandler(e) {
            if (/input|textarea/i.test(e.target.tagName) ? "Space" === e.key || "Escape" !== e.key && ("ArrowDown" !== e.key && "ArrowUp" !== e.key || e.target.closest(".dropdown-menu")) : !Z.test(e.key))
                return;
            if (e.preventDefault(),
            e.stopPropagation(),
            this.disabled || this.classList.contains("disabled"))
                return;
            const t = ae.getParentFromElement(this)
              , n = this.classList.contains("show");
            if ("Escape" === e.key)
                return (this.matches('[data-bs-toggle="dropdown"]') ? this : F.prev(this, '[data-bs-toggle="dropdown"]')[0]).focus(),
                void ae.clearMenus();
            ...
            if (!n || "Space" === e.key)
                return void ae.clearMenus();
            const i = F.find(".dropdown-menu .dropdown-item:not(.disabled):not(:disabled)", t).filter(u);
            if (!i.length)
                return;
            let o = i.indexOf(e.target);
            "ArrowUp" === e.key && o > 0 && o--,
            "ArrowDown" === e.key && o < i.length - 1 && o++,
            o = -1 === o ? 0 : o,
            i[o].focus()
        }
    }
    I.on(document, "keydown.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', ae.dataApiKeydownHandler),
    I.on(document, "keydown.bs.dropdown.data-api", ".dropdown-menu", ae.dataApiKeydownHandler),
    I.on(document, "click.bs.dropdown.data-api", ae.clearMenus),
    I.on(document, "keyup.bs.dropdown.data-api", ae.clearMenus),
    I.on(document, "click.bs.dropdown.data-api", '[data-bs-toggle="dropdown"]', (function(e) {
        e.preventDefault(),
    ...
    class de extends $ {
        ...
        show(e) {
            ...
            this._isShown || t.defaultPrevented || (this._isShown = !0,
            this._checkScrollbar(),
            this._setScrollbar(),
            this._adjustDialog(),
            this._setEscapeEvent(),
            this._setResizeEvent(),
            I.on(this._element, "click.dismiss.bs.modal", '[data-bs-dismiss="modal"]', (e=>this.hide(e))),
        ...
        hide(e) {
            ...
            t) {
                ...
                I.one(this._element, "transitionend", (e=>this._hideModal(e))),
                c(this._element, e)
            } else
                this._hideModal()
        }
        dispose() {
            [window, this._element, this._dialog].forEach((e=>I.off(e, ".bs.modal"))),
            super.dispose(),
            I.off(document, "focusin.bs.modal"),
            this._config = null,
            this._dialog = null,
        ...
        _showElement(e) {
            ...
            if (t) {
                ...
                I.one(this._dialog, "transitionend", i),
                c(this._dialog, e)
            } else
                i()
        }
        ...
        _showBackdrop(e) {
            ...
            if (this._isShown && this._config.backdrop) {
                ...
                !t)
                    return void e();
                const n = r(this._backdrop);
                I.one(this._backdrop, "transitionend", e),
                c(this._backdrop, n)
                ...
                ;
                if (t) {
                    const e = r(this._backdrop);
                    I.one(this._backdrop, "transitionend", n),
                    c(this._backdrop, e)
                } else
                    n()
            } else
        ...
        _triggerBackdropTransition() {
            ...
            I.one(this._element, "transitionend", (()=>{
                ...
                e || (I.one(this._element, "transitionend", (()=>{
        ...
        _adjustDialog() {
            const e = this._element.scrollHeight > document.documentElement.clientHeight;
            (!this._isBodyOverflowing && e && !v() || this._isBodyOverflowing && !e && v()) && (this._element.style.paddingLeft = this._scrollbarWidth + "px"),
            (this._isBodyOverflowing && !e && !v() || !this._isBodyOverflowing && e && v()) && (this._element.style.paddingRight = this._scrollbarWidth + "px")
        }
        _resetAdjustments() {
        ...
        _setScrollbar() {
            this._isBodyOverflowing && (this._setElementAttributes(".fixed-top, .fixed-bottom, .is-fixed, .sticky-top", "paddingRight", (e=>e + this._scrollbarWidth)),
        ...
        _setElementAttributes(e, t, n) {
            F.find(e).forEach((e=>{
                if (e !== document.body && window.innerWidth > e.clientWidth + this._scrollbarWidth)
                    return;
                const i = e.style[t]
                  , o = window.getComputedStyle(e)[t];
                W.setDataAttribute(e, t, i),
        ...
        _resetElementAttributes(e, t) {
            F.find(e).forEach((e=>{
                ...
                void 0 === n && e === document.body ? e.style[t] = "" : (W.removeDataAttribute(e, t),
                e.style[t] = n)
            }
            ))
        }
        ...
        static jQueryInterface(e, t) {
            return this.each((function() {
                let n = w.get(this, "bs.modal");
                const i = {
                    ...le,
                    ...W.getDataAttributes(this),
                    ..."object" == typeof e && e ? e : {}
                };
                if (n || (n = new de(this,i)),
                "string" == typeof e) {
                    if (void 0 === n[e])
    ...
    const ue = ()=>{
      ...
      , pe = (e,t,n)=>{
        const i = ue();
        F.find(e).forEach((e=>{
            if (e !== document.body && window.innerWidth > e.clientWidth + i)
                return;
            const o = e.style[t]
              , s = window.getComputedStyle(e)[t];
            W.setDataAttribute(e, t, o),
      ...
      , fe = (e,t)=>{
        F.find(e).forEach((e=>{
            const n = W.getDataAttribute(e, t);
            void 0 === n && e === document.body ? e.style.removeProperty(t) : (W.removeDataAttribute(e, t),
            e.style[t] = n)
        }
        ))
    }
    ...
    class ge extends $ {
        ...
        show(e) {
            ...
            this._config.scroll || ((e=ue())=>{
                document.body.style.overflow = "hidden",
                pe(".fixed-top, .fixed-bottom, .is-fixed", "paddingRight", (t=>t + e)),
                pe(".sticky-top", "marginRight", (t=>t - e)),
                pe("body", "paddingRight", (t=>t + e))
            }
            )(),
        ...
        hide() {
            this._isShown && (I.trigger(this._element, "hide.bs.offcanvas").defaultPrevented || (this._element.classList.add("offcanvas-toggling"),
            ...
            setTimeout((()=>{
                ...
                fe(".fixed-top, .fixed-bottom, .is-fixed", "paddingRight"),
                fe(".sticky-top", "marginRight"),
        ...
        _addEventListeners() {
            ...
            I.on(document, "keydown", (e=>{
                this._config.keyboard && "Escape" === e.key && this.hide()
            }
            )),
            I.on(document, "click.bs.offcanvas.data-api", (e=>{
                const t = F.findOne(o(e.target));
        ...
        static jQueryInterface(e) {
            return this.each((function() {
                const t = w.get(this, "bs.offcanvas") || new ge(this,"object" == typeof e ? e : {});
                if ("string" == typeof e) {
    ...
    I.on(document, "click.bs.offcanvas.data-api", '[data-bs-toggle="offcanvas"]', (function(e) {
        ...
        const n = F.findOne(".offcanvas.show, .offcanvas-toggling");
        n && n !== t || (w.get(t, "bs.offcanvas") || new ge(t)).toggle(this)
    }
    )),
    I.on(window, "load.bs.offcanvas.data-api", (()=>{
        F.find(".offcanvas.show").forEach((e=>(w.get(e, "bs.offcanvas") || new ge(e)).show()))
    }
    )),
    y("offcanvas", ge);
    const ve = new Set(["background", "cite", "href", "itemtype", "longdesc", "poster", "src", "xlink:href"])
      , ye = /^(?:(?:https?|mailto|ftp|tel|file):|[^#&/:?]*(?:[#/?]|$))/i
      , be = /^data:(?:image\/(?:bmp|gif|jpeg|jpg|png|tiff|webp)|video\/(?:mpeg|mp4|ogg|webm)|audio\/(?:mp3|oga|ogg|opus));base64,[\d+/a-z]+=*$/i
      , we = (e,t)=>{
        const n = e.nodeName.toLowerCase();
        if (t.includes(n))
            return !ve.has(n) || Boolean(ye.test(e.nodeValue) || be.test(e.nodeValue));
    ...
    function _e(e, t, n) {
        ...
        for (let e = 0, n = s.length; e < n; e++) {
            ...
            const r = [].concat(...n.attributes)
              , a = [].concat(t["*"] || [], t[i] || []);
            r.forEach((e=>{
                we(e, a) || n.removeAttribute(e.nodeName)
            }
            ))
        }
        return i.body.innerHTML
    }
    const xe = new RegExp("(^|\\s)bs-tooltip\\S+","g")
      , ke = new Set(["sanitize", "allowList", "sanitizeFn"])
      , Te = {
        animation: "boolean",
        template: "string",
    ...
    class Ae extends $ {
        ...
        show() {
            ...
            const s = this.getTipElement()
              , a = n(this.constructor.NAME);
            s.setAttribute("id", a),
            this._element.setAttribute("aria-describedby", a),
            this.setContent(),
            this.config.animation && s.classList.add("fade");
            const l = "function" == typeof this.config.placement ? this.config.placement.call(this, s, this._element) : this.config.placement
            ...
            this._popper ? this._popper.update() : this._popper = t.createPopper(this._element, s, this._getPopperConfig(d)),
            s.classList.add("show");
            const p = "function" == typeof this.config.customClass ? this.config.customClass() : this.config.customClass;
            p && s.classList.add(...p.split(" ")),
            ...
            if (this.tip.classList.contains("fade")) {
                const e = r(this.tip);
                I.one(this.tip, "transitionend", h),
                c(this.tip, e)
            } else
                h()
        }
        hide() {
            ...
            const e = this.getTipElement()
              , t = ()=>{
                this._isWithActiveTrigger() || ("show" !== this._hoverState && e.parentNode && e.parentNode.removeChild(e),
                this._cleanTipClass(),
            ...
            if (!I.trigger(this._element, this.constructor.Event.HIDE).defaultPrevented) {
                if (e.classList.remove("show"),
                "ontouchstart"in document.documentElement && [].concat(...document.body.children).forEach((e=>I.off(e, "mouseover", h))),
                this._activeTrigger.click = !1,
                this._activeTrigger.focus = !1,
                this._activeTrigger.hover = !1,
                this.tip.classList.contains("fade")) {
                    const n = r(e);
                    I.one(e, "transitionend", t),
                    c(e, n)
                } else
                    t();
                this._hoverState = ""
        ...
        setElementContent(e, t) {
            if (null !== e)
                return "object" == typeof t && l(t) ? (t.jquery && (t = t[0]),
                void (this.config.html ? t.parentNode !== e && (e.innerHTML = "",
                e.appendChild(t)) : e.textContent = t.textContent)) : void (this.config.html ? (this.config.sanitize && (t = _e(t, this.config.allowList, this.config.sanitizeFn)),
        ...
        _initializeOnDelegatedTarget(e, t) {
            ...
            return (t = t || w.get(e.delegateTarget, n)) || (t = new this.constructor(e.delegateTarget,this._getDelegateConfig()),
            w.set(e.delegateTarget, n, t)),
            t
        }
        _getOffset() {
        ...
        _getContainer() {
            return !1 === this.config.container ? document.body : l(this.config.container) ? this.config.container : F.findOne(this.config.container)
        }
        _getAttachment(e) {
        ...
        _setListeners() {
            this.config.trigger.split(" ").forEach((e=>{
                if ("click" === e)
                    I.on(this._element, this.constructor.Event.CLICK, this.config.selector, (e=>this.toggle(e)));
                else if ("manual" !== e) {
                    ...
                    I.on(this._element, t, this.config.selector, (e=>this._enter(e))),
                    I.on(this._element, n, this.config.selector, (e=>this._leave(e)))
                }
            }
            )),
        ...
        _enter(e, t) {
            ...
            t._hoverState = "show",
            t.config.delay && t.config.delay.show ? t._timeout = setTimeout((()=>{
        ...
        _getConfig(e) {
            ...
            e.sanitize && (e.template = _e(e.template, e.allowList, e.sanitizeFn)),
            e
        }
        _getDelegateConfig() {
            const e = {};
        ...
        static jQueryInterface(e) {
            return this.each((function() {
                let t = w.get(this, "bs.tooltip");
                const n = "object" == typeof e && e;
                if ((t || !/dispose|hide/.test(e)) && (t || (t = new Ae(this,n)),
                "string" == typeof e)) {
                    if (void 0 === t[e])
                        throw new TypeError(`No method named "${e}"`);
                    t[e]()
    ...
    y("tooltip", Ae);
    const Oe = new RegExp("(^|\\s)bs-popover\\S+","g")
      , je = {
        ...Ae.Default,
        placement: "right",
        offset: [0, 8],
    ...
    class De extends Ae {
        ...
        static jQueryInterface(e) {
            return this.each((function() {
                let t = w.get(this, "bs.popover");
                const n = "object" == typeof e ? e : null;
                if ((t || !/dispose|hide/.test(e)) && (t || (t = new De(this,n),
                w.set(this, "bs.popover", t)),
                "string" == typeof e)) {
                    if (void 0 === t[e])
                        throw new TypeError(`No method named "${e}"`);
                    t[e]()
    ...
    class Ne extends $ {
        ...
        refresh() {
            ...
            F.find(this._selector).map((e=>{
                const i = o(e)
                  , s = i ? F.findOne(i) : null;
                if (s) {
                    const e = s.getBoundingClientRect();
                    if (e.width || e.height)
                        return [W[t](s).top + n, i]
                }
                return null
            }
        ...
        _activate(e) {
            ...
            const t = this._selector.split(",").map((t=>`${t}[data-bs-target="${e}"],${t}[href="${e}"]`))
              , n = F.findOne(t.join(","));
            n.classList.contains("dropdown-item") ? (F.findOne(".dropdown-toggle", n.closest(".dropdown")).classList.add("active"),
        ...
        static jQueryInterface(e) {
            return this.each((function() {
                let t = w.get(this, "bs.scrollspy");
                if (t || (t = new Ne(this,"object" == typeof e && e)),
                "string" == typeof e) {
                    if (void 0 === t[e])
                        throw new TypeError(`No method named "${e}"`);
                    t[e]()
    ...
    I.on(window, "load.bs.scrollspy.data-api", (()=>{
        F.find('[data-bs-spy="scroll"]').forEach((e=>new Ne(e,W.getDataAttributes(e))))
    }
    )),
    y("scrollspy", Ne);
    class Me extends $ {
        ...
        show() {
            if (this._element.parentNode && this._element.parentNode.nodeType === Node.ELEMENT_NODE && this._element.classList.contains("active") || p(this._element))
                return;
            let e;
            ...
            const i = e ? I.trigger(e, "hide.bs.tab", {
                relatedTarget: this._element
            }) : null;
        ...
        _activate(e, t, n) {
            const i = (!t || "UL" !== t.nodeName && "OL" !== t.nodeName ? F.children(t, ".active") : F.find(":scope > li > .active", t))[0]
              , o = n && i && i.classList.contains("fade")
              , s = ()=>this._transitionComplete(e, i, n);
            if (i && o) {
                const e = r(i);
                i.classList.remove("show"),
                I.one(i, "transitionend", s),
                c(i, e)
            } else
                s()
        }
        _transitionComplete(e, t, n) {
            ...
            e.parentNode && e.parentNode.classList.contains("dropdown-menu") && (e.closest(".dropdown") && F.find(".dropdown-toggle").forEach((e=>e.classList.add("active"))),
            e.setAttribute("aria-expanded", !0)),
            n && n()
        }
        static jQueryInterface(e) {
            return this.each((function() {
                const t = w.get(this, "bs.tab") || new Me(this);
                if ("string" == typeof e) {
                    if (void 0 === t[e])
                        throw new TypeError(`No method named "${e}"`);
                    t[e]()
    ...
    I.on(document, "click.bs.tab.data-api", '[data-bs-toggle="tab"], [data-bs-toggle="pill"], [data-bs-toggle="list"]', (function(e) {
        e.preventDefault(),
        (w.get(this, "bs.tab") || new Me(this)).show()
    }
    )),
    y("tab", Me);
    const He = {
    ...
    class We extends $ {
        ...
        show() {
            ...
            this._config.animation) {
                ...
                I.one(this._element, "transitionend", e),
                c(this._element, t)
            } else
                e()
        }
        ...
        _getConfig(e) {
            ...
            d("toast", e, this.constructor.DefaultType),
            e
        }
        _setListeners() {
        ...
        static jQueryInterface(e) {
            return this.each((function() {
                let t = w.get(this, "bs.toast");
                if (t || (t = new We(this,"object" == typeof e && e)),
                "string" == typeof e) {
                    if (void 0 === t[e])
                        throw new TypeError(`No method named "${e}"`);
                    t[e](this)
    ...
    e.fn.meanmenu = function(t) {
        ...
        return this.each((function() {
            ...
            var k = ""
              ...
              , S = !1
              , C = !1;
            "right" === a && (k = "right:" + l + ";left:auto;"),
            "left" === a && (k = "left:" + l + ";right:auto;"),
            T();
            var E = ""
              , A = function() {
              ...
              , O = function() {
                ...
                jQuery(e).css("display", b),
                S = !1,
                C = !1,
                jQuery(w).removeClass("mean-remove")
            }
              , j = function() {
                ...
                if (d >= i) {
                    ...
                    jQuery(".mean-container").prepend('<div class="mean-bar">' + _ + '<a href="#nav" class="meanmenu-reveal" style="' + t + '">Show Navigation</a><nav class="mean-nav"></nav></div>');
                    var o = jQuery(e).html();
                    jQuery(".mean-nav").html(o),
                    v && jQuery("nav.mean-nav ul, nav.mean-nav ul *").each((function() {
                    ...
                    f ? h ? (jQuery(".mean-nav ul ul").each((function() {
                        jQuery(this).children().length && jQuery(this, "li:first").parent().append('<a class="mean-expand" href="#" style="font-size: ' + s + '">' + m + "</a>")
                    }
                    )),
                    jQuery(".mean-expand").on("click", (function(e) {
                        e.preventDefault(),
                        jQuery(this).hasClass("mean-clicked") ? (jQuery(this).text(m),
                    ...
                    jQuery(E).click((function(e) {
                        e.preventDefault(),
                        !1 === S ? (E.css("text-align", "center"),
                        E.css("text-indent", "0"),
                        E.css("font-size", s),
                        jQuery(".mean-nav ul:first").slideDown(),
                        S = !0) : (jQuery(".mean-nav ul:first").slideUp(),
                        S = !1),
    ...
    , , , , , function(e, t) {
        (function(t) {
            ...
            function n(e, t, n) {
                ...
                var p, f, h, m, g, v, y = 0, x = !1, k = !1, T = !0;
                if ("function" != typeof e)
                    throw new TypeError(a);
                return t = s(t) || 0,
                i(n) && (x = !!n.leading,
                h = (k = "maxWait"in n) ? b(s(n.maxWait) || 0, t) : h,
            ...
            e.exports = function(e, t, o) {
                ...
                if ("function" != typeof e)
                    throw new TypeError(a);
                return i(o) && (s = "leading"in o ? !!o.leading : s,
    ...
    , function(e, t) {
        (function(t) {
            ...
            e.exports = function(e, t, i) {
                ...
                function l(e) {
                    var n = e - v;
                    return void 0 === v || n >= t || n < 0 || k && e - _ >= h
                }
                function c() {
                    var e = w();
                    return l(e) ? d(e) : void (g = setTimeout(c, function(e) {
                        var n = t - (e - v);
                        return k ? b(n, h - (e - _)) : n
                    }(e)))
                }
                function d(e) {
                    return g = void 0,
                ...
                var p, f, h, m, g, v, _ = 0, x = !1, k = !1, T = !0;
                if ("function" != typeof e)
                    throw new TypeError(r);
                return t = o(t) || 0,
                n(i) && (x = !!i.leading,
                h = (k = "maxWait"in i) ? y(o(i.maxWait) || 0, t) : h,
...
var _self = "undefined" != typeof window ? window : "undefined" != typeof WorkerGlobalScope && self instanceof WorkerGlobalScope ? self : {}
  , Prism = function(e) {
    var t = /\blang(?:uage)?-([\w-]+)\b/i
      ...
      , i = {
        ...
        util: {
            ...
            clone: function e(t, n) {
                ...
                case "Object":
                    ...
                    n[s] = o,
                    t)
                        t.hasOwnProperty(r) && (o[r] = e(t[r], n));
                    return o;
                case "Array":
                    return s = i.util.objId(t),
                    n[s] ? n[s] : (o = [],
                    n[s] = o,
            ...
            DFS: function e(t, n, o, s) {
                ...
                for (var a in t)
                    if (t.hasOwnProperty(a)) {
                        ...
                        var l = t[a]
                          , c = i.util.type(l);
                        "Object" !== c || s[r(l)] ? "Array" !== c || s[r(l)] || (s[r(l)] = !0,
                        e(l, n, a, s)) : (s[r(l)] = !0,
                        e(l, n, null, s))
                    }
            }
        ...
        highlightAllUnder: function(e, t, n) {
            ...
            i.hooks.run("before-all-elements-highlight", o);
            for (var s, r = 0; s = o.elements[r++]; )
                i.highlightElement(s, !0 === t, o.callback)
        },
        highlightElement: function(n, o, s) {
            ...
            if (i.hooks.run("before-sanity-check", c),
            !c.code)
                return i.hooks.run("complete", c),
                void (s && s.call(c.element));
            if (i.hooks.run("before-highlight", c),
            c.grammar)
                if (o && e.Worker) {
                    ...
                    d(i.highlight(c.code, c.grammar, c.language));
            else
                d(i.util.encode(c.code))
        },
        highlight: function(e, t, n) {
            ...
            return i.hooks.run("before-tokenize", s),
            s.tokens = i.tokenize(s.code, s.grammar),
            i.hooks.run("after-tokenize", s),
            o.stringify(i.util.encode(s.tokens), s.language)
        },
        ...
        for (var p in n)
            if (n.hasOwnProperty(p) && n[p]) {
                ...
                for (var h = 0; h < f.length; ++h) {
                    ...
                    for (var _ = m.pattern || m, x = a.next, k = d; x !== t.tail && !(u && k >= u.reach); k += x.value.length,
                    x = x.next) {
                        var T = x.value;
                        ...
                        if (!(T instanceof o)) {
                            ...
                            if (y) {
                                ...
                                var E = S.index
                                  ...
                                  , O = k;
                                for (O += x.value.length; E >= O; )
                                    O += (x = x.next).value.length;
                                if (k = O -= x.value.length,
                                x.value instanceof o)
                                    continue;
                                for (var j = x; j !== t.tail && (O < A || "string" == typeof j.value); j = j.next)
                                    C++,
                                    O += j.value.length;
                                C--,
                                T = e.slice(k, O),
                            ...
                            k += P.length),
                            c(t, $, C),
                            x = l(t, $, new o(p,g ? i.tokenize(L, g) : L,b,L)),
                            D && l(t, x, D),
                            C > 1 && r(e, t, n, x.prev, k, {
                                cause: p + "," + h,
                                reach: I
                            })
                        }
    ...
    function c(e, t, n) {
        for (var i = t.next, o = 0; o < n && i !== e.tail; o++)
            i = i.next;
        t.next = i,
        i.prev = t,
        e.length -= o
    ...
    !e.document)
        return e.addEventListener ? (i.disableWorkerMessageHandler || e.addEventListener("message", (function(t) {
            var n = JSON.parse(t.data)
              ...
              , s = n.code
              , r = n.immediateClose;
            e.postMessage(i.highlight(s, i.languages[o], o)),
            r && e.close()
        }
        ), !1),
        i) : i;
    ...
    !i.manual) {
        ...
        "loading" === p || "interactive" === p && d && d.defer ? document.addEventListener("DOMContentLoaded", u) : window.requestAnimationFrame ? window.requestAnimationFrame(u) : window.setTimeout(u, 16)
    }
    return i
}(_self);
/**
    ...
    if ("undefined" != typeof self && self.Prism && self.document) {
        ...
        e.hooks.add("before-sanity-check", (function(r) {
            ...
            if (a.matches(s)) {
                ...
                h.onreadystatechange = function() {
                    var t, i;
                    4 == h.readyState && (h.status < 400 && h.responseText ? (a.setAttribute(n, o),
                    c.textContent = h.responseText,
                    e.highlightElement(c)) : (a.setAttribute(n, "failed"),
                    h.status >= 400 ? c.textContent = (t = h.status,
                    i = h.statusText,
                    "✖ Error " + t + " while fetching file: " + i) : c.textContent = "✖ Error: File does not exist or is empty"))
                }
                ,
                h.send(null)
            }
        ...
        e.plugins.fileHighlight = {
            highlight: function(t) {
                for (var n, i = (t || document).querySelectorAll(s), o = 0; n = i[o++]; )
...
function(e) {
    ...
    var t, n, i, o, s, r, a = "Close", l = "BeforeClose", c = "MarkupParse", d = "Open", u = "Change", p = "mfp", f = "." + p, h = "mfp-ready", m = "mfp-removing", g = "mfp-prevent-close", v = function() {}, y = !!window.jQuery, b = e(window), w = function(e, n) {
        t.ev.on(p + e + f, n)
    }, _ = function(t, n, i, o) {
    ...
    v.prototype = {
        ...
        open: function(n) {
            ...
            if (!t.isOpen) {
                ...
                t.bgOverlay || (t.bgOverlay = _("bg").on("click" + f, (function() {
                    t.close()
                }
                )),
                t.wrap = _("wrap").attr("tabindex", -1).on("click" + f, (function(e) {
            ...
            getInline: function(n, i) {
                ...
                n.src) {
                    ...
                    if (s.length) {
                        ...
                        C = _(S),
                        S = "mfp-" + S),
                        E = s.after(C).detach().removeClass(S)),
                ...
                var n = 0
                  ...
                  , o = function(s) {
                    ...
                    I = setInterval((function() {
                        return i.naturalWidth > 0 ? void t._onImageHasSize(e) : (n > 200 && clearInterval(I),
    ...
    e.magnificPopup.registerModule("zoom", {
        ...
        proto: {
            ...
            _getOffset: function(n) {
                ...
                N ? a["-moz-transform"] = a.transform = "translate(" + o.left + "px," + o.top + "px)" : (a.left = o.left,
                a.top = o.top),
                a
            }
        }
    ...
    e.magnificPopup.registerModule("gallery", {
        ...
        proto: {
            initGallery: function() {
                ...
                w(c + o, (function(e, i, o, s) {
                    var r = t.items.length;
                    o.counter = r > 1 ? W(n.tCounter, s.index, r) : ""
                }
                )),
        ...
        function l(e, t, n) {
            ...
            return e.each((function(e, l) {
                ...
                if (c) {
                    ...
                    o(i + " not initialized. Cannot call methods, i.e. " + r)
            }
            )),
            void 0 !== s ? s : e
        }
    ...
    function a(t) {
        ...
        t && "object" == typeof t && t.nodeType) {
            ...
            var m = c.paddingLeft + c.paddingRight
              ...
              , _ = d && s
              , x = e(l.width);
            !1 !== x && (c.width = x + (_ ? 0 : m + b));
            var k = e(l.height);
            return !1 !== k && (c.height = k + (_ ? 0 : g + w)),
    ...
    n.filterFindElements = function(e, i) {
        ...
        return e.forEach((function(e) {
            if (e instanceof HTMLElement)
                if (i) {
                    t(e, i) && o.push(e);
                    for (var n = e.querySelectorAll(i), s = 0; s < n.length; s++)
                        o.push(n[s])
                } else
                    o.push(e)
        }
    ...
    return n.htmlInit = function(t, i) {
        n.docReady((function() {
            ...
            c.forEach((function(e) {
                var n, s = e.getAttribute(r) || e.getAttribute(d);
                try {
                    n = s && JSON.parse(s)
                } catch (t) {
...
function(e, t) {
    ...
    ,
    u._positionItem = function(e, t, n, i, o) {
    ...
    ,
    i.debounceMethod(d, "onresize", 100),
    u.resize = function() {
    ...
    d.create = function(e, t) {
        var n = p(d);
        return n.defaults = i.extend({}, d.defaults),
        i.extend(n.defaults, t),
        n.compatOptions = i.extend({}, d.compatOptions),
        n.namespace = e,
        n.data = d.data,
        n.Item = p(o),
        i.htmlInit(n, e),
        r && r.bridget && r.bridget(e, n),
        n
    }
    ;
    var f = {
...
function(e, t) {
    ...
    i._getItemLayoutPosition = function(e) {
        ...
        for (var i = this[this.options.horizontalOrder ? "_getHorizontalColPosition" : "_getTopColPosition"](n, e), o = {
            ...
            y: i.y
        }, s = i.y + e.size.outerHeight, r = n + i.col, a = i.col; a < r; a++)
            this.colYs[a] = s;
        return o
    }
    ,
    ...
    i._manageStamp = function(e) {
        ...
        for (var l = (this._getOption("originTop") ? i.top : i.bottom) + n.outerHeight, c = r; c <= a; c++)
...
function(e, t, n, i) {
    ...
    e.extend(d.prototype, {
        init: function() {
            var t, n = "", i = "", o = "", s = "", r = "", a = "", l = "", c = "", d = "", u = "", p = "", f = "", h = "", m = this;
            for (var g in this.settings.elements)
                if ("volume" == this.settings.elements[g])
                    s += "<div class='volume'><div class='volume-btn' title='Volume'></div><div class=' volume-adjust'><div><div></div></div></div></div>";
                else if ("progress" == this.settings.elements[g])
                    s += "<div class='progressbar'><div class='bar-loaded' ></div><div class='bar-played'></div></div>";
                else if ("artwork" == this.settings.elements[g])
                    s += "<div class='cover'></div>";
                else if ("information" == this.settings.elements[g]) {
                    for (var v in r = "-1" != e.inArray("title", this.settings.infoElements) ? "<div class='title'></div>" : " ",
                    a = "-1" != e.inArray("artist", this.settings.infoElements) ? "<div class='artist'></div>" : " ",
                    this.settings.infoElements)
                        "title" == this.settings.infoElements[v] ? o += r : "artist" == this.settings.infoElements[v] && (o += a);
                    s += "<div class='info' >" + o + "</div>"
                } else if ("time" == this.settings.elements[g]) {
                    for (var v in p = "-1" != e.inArray("current", this.settings.timeElements) ? "<div class='time-current'></div>" : " ",
                    f = "-1" != e.inArray("duration", this.settings.timeElements) ? "<div class='time-duration'></div>" : " ",
                    h = "<div class='time-separator'>" + this.settings.timeSeparator.replace(/\s/g, "&nbsp;") + "</div>",
                    this.settings.timeElements)
                        1 == v && (i += h),
                        "current" == this.settings.timeElements[v] ? i += p : "duration" == this.settings.timeElements[v] && (i += f);
                    s += "<div class='timeHolder'>" + i + "</div>"
                } else if ("controls" == this.settings.elements[g]) {
                    for (var v in l = "-1" != e.inArray("backward", this.settings.controlElements) ? "<div class='rew'></div>" : " ",
                    c = "-1" != e.inArray("forward", this.settings.controlElements) ? "<div class='fwd'></div>" : " ",
                    d = "-1" != e.inArray("stop", this.settings.controlElements) ? "<div class='stop'></div>" : " ",
                    u = "-1" != e.inArray("play", this.settings.controlElements) ? "<div class='play'></div><div class='pause'></div>" : " ",
                    this.settings.controlElements)
                        "backward" == this.settings.controlElements[v] ? n += l : "play" == this.settings.controlElements[v] ? n += u : "forward" == this.settings.controlElements[v] ? n += c : "stop" == this.settings.controlElements[v] && (n += d);
                    s += "<div class='controls'>" + n + "</div>"
                }
            t = e("<div class='player' >" + s + "</div>"),
            this.settings.playerAbovePlaylist ? e(t).insertBefore(e(this.element).find(".playlist")) : e(t).insertAfter(e(this.element).find(".playlist")),
            this.playlistItemSelector = this.settings.playlistItemSelector,
            this.playlistHolder = e(this.element).children(".playlist"),
            this.playerHolder = e(this.element).children(".player"),
            this.song = "",
            ...
            this.controlPlay = e(this.controlsInfo).find(".play"),
            this.controlPause = e(this.controlsInfo).find(".pause"),
            this.controlStop = e(this.controlsInfo).find(".stop"),
            this.controlFwd = e(this.controlsInfo).find(".fwd"),
            this.controlRew = e(this.controlsInfo).find(".rew"),
            this.cssClass = {
                playing: "playing",
                mute: "mute"
            },
            /iPad|iPhone|iPod/.test(navigator.userAgent) && e(this.volumeInfo).hide(),
            this.initAudio(e(this.playlistHolder.find(this.playlistItemSelector + ":first"))),
            this.song.volume = this.volumeValue,
            this.timeDuration.html("&hellip;"),
            this.timeCurrent.text(this.secondsToTime(0)),
            e(this.controlPlay).click((function(e) {
                e.preventDefault(),
                m.playAudio()
            }
            )),
            e(this.controlPause).click((function(e) {
                e.preventDefault(),
                m.stopAudio(),
                m.settings.onPause()
            }
            )),
            e(this.controlFwd).click((function(t) {
                t.preventDefault(),
                m.stopAudio();
                var n = m.getSong(!0);
                0 == n.length && (n = e(m.playlistHolder).find(m.playlistItemSelector + ":first")),
                m.loadNewSong(n),
                m.playAudio(),
                m.settings.onFwd()
            }
            )),
            e(this.controlRew).click((function(t) {
                t.preventDefault(),
                m.stopAudio();
                var n = m.getSong(!1);
                0 == n.length && (n = e(m.playlistHolder).find(m.playlistItemSelector + ":last")),
                m.loadNewSong(n),
                m.playAudio(),
                m.settings.onRew()
            }
            )),
            e(this.controlStop).click((function(e) {
                e.preventDefault(),
                m.stopAudio(),
                m.song.currentTime = 0,
                m.settings.onStop()
            }
            )),
            e(this.playlistHolder).find(this.playlistItemSelector).click((function(t) {
                t.preventDefault(),
                m.stopAudio(),
                m.loadNewSong(e(this)),
                m.playAudio(),
                m.settings.trackClicked()
            }
            ))
        },
        secondsToTime: function(e) {
            var t = Math.floor(e / 3600)
              ...
              , i = Math.ceil(e % 3600 % 60);
            return (0 == t ? "" : t > 0 && t.toString().length < 2 ? "0" + t + ":" : t + ":") + (n.toString().length < 2 ? "0" + n : n) + ":" + (i.toString().length < 2 ? "0" + i : i)
        },
        adjustVolume: function(e) {
            var t = r ? e.originalEvent.touches[0] : e;
            this.song.volume = Math.abs((t.pageX - this.volumeAdjuster.offset().left) / this.volumeAdjuster.width())
        },
        adjustCurrentTime: function(e) {
            var t = r ? e.originalEvent.touches[0] : e;
            this.song.currentTime = Math.round(this.song.duration * (t.pageX - this.theBar.offset().left) / this.theBar.width())
        },
        initAudio: function(t) {
            var n = t.children("a:first-child").attr("href")
              , i = t.text()
              , o = t.attr("data-cover")
              , s = t.attr("data-artist")
              , r = this;
            e(this.trackInfo).children(".title").text(i),
            e(this.trackInfo).children(".artist").text(s),
            e(this.coverInfo).css("background-image", "url(" + o + ")"),
            this.song = new Audio(n),
            this.song.load(),
            this.song.addEventListener("loadeddata", (function() {
                e(r.timeDuration).html(r.secondsToTime(this.duration)),
                e(r.volumeAdjuster).find("div").width(100 * this.volume + "%"),
                r.volumeDefault = this.volume
            }
            ), !1),
            this.song.addEventListener("progress", (function() {
                e(r.barLoaded).width(this.buffered.end(0) / this.duration * 100 + "%")
            }
            )),
            this.song.addEventListener("timeupdate", (function() {
                e(r.timeCurrent).text(r.secondsToTime(this.currentTime)),
                e(r.barPlayed).width(this.currentTime / this.duration * 100 + "%")
            }
            )),
            this.song.addEventListener("volumechange", (function() {
                Number(Math.round(100 * this.volume + "e1") + "e-1") <= .4 && (this.volume = 0),
                e(r.volumeAdjuster).find("div").width(100 * this.volume + "%"),
                this.volume > 0 && r.playerHolder.hasClass(r.cssClass.mute) && r.playerHolder.removeClass(r.cssClass.mute),
                this.volume <= 0 && !r.playerHolder.hasClass(r.cssClass.mute) && r.playerHolder.addClass(r.cssClass.mute),
                r.volumeValue = this.volume
            }
            )),
            this.song.addEventListener("ended", (function() {
                r.settings.autoPlay ? r.autoPlayNext() : (r.playerHolder.removeClass(r.cssClass.playing),
                e(r.controlPlay).removeClass("hidden"),
                e(r.controlPause).removeClass("visible"))
            }
            )),
            e(this.volumeButton).on("click", (function() {
                return e(r.playerHolder).hasClass(r.cssClass.mute) ? (e(r.playerHolder).removeClass(r.cssClass.mute),
                r.song.volume = r.volumeDefault) : (e(r.playerHolder).addClass(r.cssClass.mute),
                r.volumeDefault = r.song.volume,
                r.song.volume = 0,
                r.settings.onMute()),
                !1
            }
            )),
            e(this.volumeAdjuster).on(a, (function(e) {
                r.adjustVolume(e),
                r.volumeAdjuster.on(l, (function(e) {
                    r.adjustVolume(e)
                }
                )),
                r.settings.volumeChanged()
            }
            )).on(c, (function() {
                r.volumeAdjuster.unbind(l)
            }
            )),
            e(this.theBar).on(a, (function(e) {
                r.adjustCurrentTime(e),
                r.theBar.on(l, (function(e) {
                    r.adjustCurrentTime(e)
                }
                ))
            }
            ...
            e(this.playlistHolder).find(r.playlistItemSelector).removeClass("active"),
            t.addClass("active"),
        ...
        playAudio: function() {
            ...
            "-1" != e.inArray("controls", this.settings.elements) && "-1" != e.inArray("play", this.settings.controlElements) && (e(this.controlPlay).addClass("hidden"),
            e(this.controlPause).addClass("visible")),
            this.settings.onPlay()
        },
        stopAudio: function() {
            this.song.pause(),
            this.playerHolder.removeClass(this.cssClass.playing),
            "-1" != e.inArray("controls", this.settings.elements) && "-1" != e.inArray("play", this.settings.controlElements) && (e(this.controlPlay).removeClass("hidden"),
            e(this.controlPause).removeClass("visible"))
        },
        autoPlayNext: function() {
            this.stopAudio();
            var t = this.getSong(!0);
            0 == t.length && this.settings.loop ? (t = e(this.playlistHolder).find(this.playlistItemSelector + ":first"),
            this.loadNewSong(t),
            this.playAudio()) : 0 == !t.length && (this.loadNewSong(t),
            this.playAudio())
        },
        getSong: function(t) {
            var n = e(this.playlistHolder).find(this.playlistItemSelector)
              , i = e(this.playlistItemSelector + ".active");
            return t ? n.eq(n.index(i) + 1) : n.eq(n.index(i) - 1)
        },
        loadNewSong: function(e) {
    ...
    e.fn[o] = function(t) {
        return this.each((function() {
            e.data(this, "plugin_" + o) || e.data(this, "plugin_" + o, new d(this,t))
        }
        ))
    }
...
function(e) {
    ...
    e("[data-scroll]").on("click", (function(t) {
        t.preventDefault();
    ...
    e(".search-toggler").on("click", (function(t) {
        e(".search-form").toggleClass("open"),
        t.preventDefault()
    }
    )),
    e(".navbar-meanmenu").meanmenu({
        meanScreenWidth: "991",
        meanMenuContainer: ".header-navbar",
        meanMenuOpen: "<span></span><span></span><span></span>",
        meanMenuClose: "<span></span><span></span><span></span>",
        siteLogo: "<a class='navbar-mobile' href='index.html'>Nurul Ilmi</a>"
    }),
    function() {
        ...
        t.on("init", (function(t, i) {
            n(e(".banner-item:first-child").find("[data-animation]"))
        }
        )),
        t.on("beforeChange", (function(t, i, o, s) {
            n(e('.banner-item[data-slick-index="' + s + '"]').find("[data-animation]"))
        }
        )),
        t.slick({
            autoplay: !0,
            ...
            arrows: !0,
            speed: 0,
            prevArrow: e(".banner-prev"),
            nextArrow: e(".banner-next")
        })
    }(),
    e(".prayer-slider").slick({
        autoplay: !0,
        autoplaySpeed: 2e3,
        infinite: !0,
        speed: 1e3,
    ...
    e("#video-modal,.video-popup").magnificPopup({
        type: "iframe",
        iframe: {
            patterns: {
                youtube: {
    ...
    e(".prayer-countdown").length) {
        const e = 1e3
          , t = 60 * e
          , n = 60 * t
          , i = 24 * n;
        let o = new Date("Sep 30, 2021 00:00:00").getTime();
        setInterval((function() {
            let s = (new Date).getTime()
              , r = o - s;
            document.getElementById("hours").innerText = Math.floor(r % i / n),
            document.getElementById("minutes").innerText = Math.floor(r % n / t),
            document.getElementById("seconds").innerText = Math.floor(r % t / e)
        }
        ), 0)
    }
    if (e(".maintain-countdown").length) {
        const e = 1e3
          , t = 60 * e
          , n = 60 * t
          , i = 24 * n;
    ...
    if (e(".donation-countdown").length) {
        const e = 1e3
          , t = 60 * e
          , n = 60 * t
          , i = 24 * n;
    ...
    e(".counter-numbers").length > 0 && e(window).on("load", (function() {
        e(".counter-numbers").counterUp({
            delay: 10,
            time: 1e3
        })
    }
