...
<body>
    ...
    <div class="team-area py-lg-10 py-8">
        <div class="container">
                ...
                <div class="col-sm-6 col-lg-3">
                    <div class="team-item mt-4">
                        <div class="team-image">
                            ...
                            <img src="<?= base_url('upload/bidang/'.$humas->foto) ?>" alt="title">
                            <?php else: ?>
                            <img src="<?= base_url('upload/default.png') ?>" alt="">
                            <?php endif; ?>
                        </div>
                        <div class="team-content">
                            <h5>Nama &nbsp;: <?= $humas->nama ?></h5>
                            <span class="text-primary">Jabatan : <?= $humas->jabatan ?></span>
                            <br>
                            <span>Alamat &nbsp;: <?= $humas->alamat ?></span>
                        </div>
                    </div>
                </div>
                <?php endforeach; ?>
            ...
            <?php else: ?>
            <h3 class="text-center">"Data Hubungan Masyarakat Belum Ada"</h3>
            <?php endif; ?>
        </div>
    </div>
    <!--  ====================== Footer Area =============================  -->
